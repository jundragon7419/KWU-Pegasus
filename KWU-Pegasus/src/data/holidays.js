...
export const FIXED_HOLIDAYS = [
  ...
  { month: 10, day: 9,  name: '한글날', from: 2013 }, // 2013년 공휴일 재지정
...
export const VARIABLE_HOLIDAYS = {
  ...
  2002: [
    ...
    { month: 2, day: 13, name: '설날 연휴' },
    { month: 5, day: 19, name: '부처님오신날' },
    { month: 9, day: 20, name: '추석 연휴' },
    { month: 9, day: 21, name: '추석' },
    { month: 9, day: 22, name: '추석 연휴' },
  ],
  2003: [
    { month: 1, day: 31, name: '설날 연휴' },
    { month: 2, day: 1,  name: '설날' },
    { month: 2, day: 2,  name: '설날 연휴' },
    { month: 5, day: 8,  name: '부처님오신날' },
    { month: 9, day: 10, name: '추석 연휴' },
    { month: 9, day: 11, name: '추석' },
    { month: 9, day: 12, name: '추석 연휴' },
  ],
  2004: [
    { month: 1, day: 21, name: '설날 연휴' },
    { month: 1, day: 22, name: '설날' },
    { month: 1, day: 23, name: '설날 연휴' },
    { month: 5, day: 26, name: '부처님오신날' },
    { month: 9, day: 27, name: '추석 연휴' },
    { month: 9, day: 28, name: '추석' },
    { month: 9, day: 29, name: '추석 연휴' },
  ],
  2005: [
  ...
  2009: [
    ...
    { month: 10, day: 2, name: '추석 연휴' },
    { month: 10, day: 3, name: '추석' }, // 개천절과 동일
    { month: 10, day: 4, name: '추석 연휴' },
  ],
  2010: [
    { month: 2, day: 13, name: '설날 연휴' },
    { month: 2, day: 14, name: '설날' },
    { month: 2, day: 15, name: '설날 연휴' },
    { month: 5, day: 21, name: '부처님오신날' },
  ...
  2014: [
    ...
    { month: 2, day: 1,  name: '설날 연휴' },
    { month: 2, day: 3,  name: '대체공휴일' }, // 설날 연휴(2/1 토) 대체
    { month: 5, day: 6,  name: '부처님오신날' },
    { month: 9, day: 7,  name: '추석 연휴' },
    { month: 9, day: 8,  name: '추석' },
    { month: 9, day: 9,  name: '추석 연휴' },
  ],
  2015: [
    { month: 2, day: 18, name: '설날 연휴' },
    { month: 2, day: 19, name: '설날' },
    { month: 2, day: 20, name: '설날 연휴' },
  ...
  2016: [
    { month: 2, day: 7,  name: '설날 연휴' },
    { month: 2, day: 8,  name: '설날' },
    { month: 2, day: 9,  name: '설날 연휴' },
    { month: 2, day: 10, name: '대체공휴일' }, // 설날 연휴(2/9 화)와 설날(2/8 월)로 이미 평일 3일 → 대체 없음; 실제로는 2/10 임시공휴일 지정됨
    { month: 5, day: 14, name: '부처님오신날' },
  ...
  2017: [
    ...
    { month: 5, day: 3,  name: '부처님오신날' },
    { month: 10, day: 3, name: '추석 연휴' }, // 개천절과 동일
    { month: 10, day: 4, name: '추석' },
    { month: 10, day: 5, name: '추석 연휴' },
    { month: 10, day: 6, name: '대체공휴일' }, // 추석 연휴(10/3 = 개천절) 대체
  ],
  2018: [
    { month: 2, day: 15, name: '설날 연휴' },
    { month: 2, day: 16, name: '설날' },
    { month: 2, day: 17, name: '설날 연휴' },
    { month: 2, day: 19, name: '대체공휴일' }, // 설날 연휴(2/17 토) 대체
    { month: 5, day: 22, name: '부처님오신날' },
    { month: 9, day: 23, name: '추석 연휴' },
    { month: 9, day: 24, name: '추석' },
    { month: 9, day: 25, name: '추석 연휴' },
    { month: 9, day: 26, name: '대체공휴일' }, // 추석(9/24 월) 아님. 실제로는 임시공휴일 9/26 지정
  ],
  2019: [
    { month: 2, day: 4,  name: '설날 연휴' },
    { month: 2, day: 5,  name: '설날' },
    { month: 2, day: 6,  name: '설날 연휴' },
    { month: 5, day: 6,  name: '대체공휴일' }, // 어린이날(5/5 일) 대체
    { month: 5, day: 12, name: '부처님오신날' },
    { month: 9, day: 12, name: '추석 연휴' },
    { month: 9, day: 13, name: '추석' },
    { month: 9, day: 14, name: '추석 연휴' },
    { month: 9, day: 16, name: '대체공휴일' }, // 추석 연휴(9/14 토) 대체
  ],
  2020: [
    { month: 1, day: 24, name: '설날 연휴' },
    { month: 1, day: 25, name: '설날' },
    { month: 1, day: 26, name: '설날 연휴' },
    { month: 1, day: 27, name: '대체공휴일' }, // 설날(1/25 토), 연휴(1/26 일) 대체
    { month: 4, day: 30, name: '부처님오신날' },
    { month: 9, day: 30, name: '추석 연휴' },
    { month: 10, day: 1, name: '추석' },
    { month: 10, day: 2, name: '추석 연휴' },
  ...
  2021: [
    ...
    { month: 2, day: 12, name: '설날' },
    { month: 2, day: 13, name: '설날 연휴' },
    { month: 2, day: 15, name: '대체공휴일' }, // 설날 연휴(2/13 토) 대체
    { month: 5, day: 19, name: '부처님오신날' },
    { month: 8, day: 16, name: '대체공휴일' }, // 광복절(8/15 일) 대체
    { month: 9, day: 20, name: '추석 연휴' },
    { month: 9, day: 21, name: '추석' },
    { month: 9, day: 22, name: '추석 연휴' },
    { month: 10, day: 4, name: '대체공휴일' }, // 개천절(10/3 일) 대체
    { month: 10, day: 11, name: '대체공휴일' }, // 한글날(10/9 토) 대체
  ],
  2022: [
    { month: 1, day: 31, name: '설날 연휴' },
    { month: 2, day: 1,  name: '설날' },
    { month: 2, day: 2,  name: '설날 연휴' },
    { month: 5, day: 8,  name: '부처님오신날' },
    { month: 6, day: 1,  name: '대체공휴일' }, // 현충일(6/6 월)? - 실제로 선거가 있었음. 아님.
    { month: 9, day: 9,  name: '추석 연휴' },
    { month: 9, day: 10, name: '추석' },
    { month: 9, day: 11, name: '추석 연휴' },
    { month: 9, day: 12, name: '대체공휴일' }, // 추석(9/10 토), 연휴(9/11 일) 대체
  ],
  2023: [
    { month: 1, day: 21, name: '설날 연휴' },
    { month: 1, day: 22, name: '설날' },
    { month: 1, day: 23, name: '설날 연휴' },
    { month: 1, day: 24, name: '대체공휴일' }, // 설날 연휴(1/21 토, 1/22 일) 대체
    { month: 5, day: 27, name: '부처님오신날' },
    { month: 5, day: 29, name: '대체공휴일' }, // 부처님오신날(5/27 토) 대체 (2023년 적용 확대)
    { month: 9, day: 28, name: '추석 연휴' },
    { month: 9, day: 29, name: '추석' },
    { month: 9, day: 30, name: '추석 연휴' },
    { month: 10, day: 2, name: '대체공휴일' }, // 추석 연휴(9/30 토) 대체
  ],
  2024: [
    { month: 2, day: 9,  name: '설날 연휴' },
    { month: 2, day: 10, name: '설날' },
    { month: 2, day: 11, name: '설날 연휴' },
    { month: 2, day: 12, name: '대체공휴일' }, // 설날(2/10 토), 연휴(2/11 일) 대체
    { month: 5, day: 6,  name: '대체공휴일' }, // 어린이날(5/5 일) 대체
    { month: 5, day: 15, name: '부처님오신날' },
    { month: 9, day: 16, name: '추석 연휴' },
  ...
  2025: [
    ...
    { month: 1, day: 30, name: '설날 연휴' },
    { month: 5, day: 5,  name: '부처님오신날' }, // 어린이날과 동일
    { month: 5, day: 6,  name: '대체공휴일' }, // 부처님오신날(5/5 월 = 어린이날) 대체
    { month: 10, day: 5, name: '추석 연휴' },
    { month: 10, day: 6, name: '추석' },
    { month: 10, day: 7, name: '추석 연휴' },
    { month: 10, day: 8, name: '대체공휴일' }, // 추석 연휴(10/5 일) 대체
  ],
  2026: [
    ...
    { month: 2, day: 18, name: '설날 연휴' },
    { month: 5, day: 24, name: '부처님오신날' },
    { month: 5, day: 25, name: '대체공휴일' }, // 부처님오신날(5/24 일) 대체
    { month: 8, day: 17, name: '대체공휴일' }, // 광복절(8/15 토) 대체
    { month: 9, day: 24, name: '추석 연휴' },
    { month: 9, day: 25, name: '추석' },
    { month: 9, day: 26, name: '추석 연휴' },
    { month: 9, day: 28, name: '대체공휴일' }, // 추석 연휴(9/26 토) 대체
    { month: 10, day: 5, name: '대체공휴일' }, // 개천절(10/3 토) 대체
  ],
