...
-- ── 게시판 예시 ──────────────────────────────────────────────────
INSERT IGNORE INTO posts (type, pin_until, title, author, date, views, content) VALUES
-- 공지/행사/경기 (pin_until = '9999-12-31' → 무한 고정, NULL → 고정 안 함)
('notice', '9999-12-31', '2026 시즌 운영 방침 안내',    '김기민', '2026-02-20', 320, '2026 시즌을 맞아 팀 운영 방침을 안내드립니다. 훈련 결석 시 사전 연락 필수, 공식전 2회 이상 무단 결석 시 출전 제한 등 기본 규칙을 준수해 주시기 바랍니다.'),
('notice', '9999-12-31', '회비 납부 안내',               '김기민', '2026-02-25', 278, '2026 시즌 회비 납부 기한은 3월 31일입니다. 계좌번호는 개별 연락드린 내용을 참고해 주세요. 기한 내 미납 시 시즌 참가가 제한될 수 있습니다.'),
('event',  NULL,         '4월 OB-YB 친선전 개최',        '김기민', '2026-03-05', 198, '매년 진행되는 OB-YB 친선전을 4월 중 개최할 예정입니다. 졸업생 분들의 많은 참여 부탁드립니다. 일정은 추후 확정 후 공지하겠습니다.'),
('game',   NULL,         '2026 봄 리그 첫 경기 일정',    '심동현', '2026-03-10', 412, '봄 리그 첫 경기가 4월 5일로 확정되었습니다. 상대팀은 건국대학교입니다. 전원 참석 부탁드리며 응원 나와주실 분들도 환영합니다.'),
('notice', NULL,         '훈련복 수령 안내',             '김기민', '2026-03-13', 145, '새 훈련복이 입고되었습니다. 이번 주 훈련 때 수령 가능합니다. 못 받으신 분은 총무에게 개별 연락 주세요.'),
('game',   NULL,         '4월 경기 일정 전체 공개',       '심동현', '2026-03-18', 233, '4월 경기 일정을 공개합니다. 4/5 건국대, 4/12 성균관대, 4/19 연세대 순으로 진행됩니다. 각 경기 장소는 추후 개별 공지합니다.'),
('event',  NULL,         '종강 뒤풀이 장소 투표',         '김기민', '2026-03-20', 167, '1학기 종강 뒤풀이 장소를 투표로 결정하려 합니다. 의견 있으신 분들은 단체 채팅방에 댓글 달아주세요.'),
-- 일반 게시글 (pin 불가, pin_until 항상 NULL)
('normal', NULL,         '2026 시즌 첫 훈련 후기',        '김승원', '2026-03-02', 142, '오늘 시즌 첫 훈련이 있었습니다. 다들 겨울 동안 체력을 잘 키워왔는지 컨디션이 좋아 보였습니다. 올 시즌도 열심히 해봅시다!'),
('normal', NULL,         '지난 주 연습 경기 총평',         '심동현', '2026-03-08', 98,  '지난 주 연습 경기에서 아쉬운 부분들이 있었습니다. 수비 위치 선정과 타격 타이밍을 집중적으로 보완해야 할 것 같습니다.'),
('normal', NULL,         '새 유니폼 어떤가요?',            '김기민', '2026-03-10', 215, '이번 시즌 새로 맞춘 유니폼 다들 받으셨죠? 착용감이나 디자인에 대한 의견 자유롭게 남겨주세요.'),
('normal', NULL,         '훈련 자유 참여 안내',            '김기민', '2026-03-12', 77,  '이번 주 목요일 훈련은 자유 참여입니다. 참석 가능한 분들은 오후 4시까지 운동장으로 와주세요.'),
('normal', NULL,         '스트레칭 중요성에 대해',          '이찬영', '2026-03-15', 63,  '부상 방지를 위해 훈련 전후 스트레칭을 꼭 챙겨주세요. 특히 어깨와 허리 스트레칭을 꼼꼼히 해주시면 좋겠습니다.'),
('normal', NULL,         '3월 첫 공식전 준비 현황',         '심동현', '2026-03-17', 189, '다음 달 첫 공식전을 앞두고 포지션 배치를 확정했습니다. 각자 역할에 맞게 집중 훈련 부탁드립니다.'),
('normal', NULL,         '운동장 사용 일정 공유',           '김기민', '2026-03-19', 54,  '4월 운동장 사용 일정을 공유합니다. 개인 일정과 겹치는 분들은 미리 말씀해 주세요.');
