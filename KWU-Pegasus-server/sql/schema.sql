...
-- ── 설정 ────────────────────────────────────────────────────────
INSERT INTO settings (`key`, `value`) VALUES ('active_roster_year', '2026');

-- ── 로스터 ──────────────────────────────────────────────────────
INSERT INTO roster (year, number, name, role, title) VALUES
...
(2026,9,'정현수','player',NULL),(2026,10,'강상현','player',NULL),(2026,11,'심동현','staff','감독'),
...
(2026,18,'김기민','staff','회장'),(2026,19,'안지언','player',NULL),(2026,20,'이준용','player',NULL),
...
(2026,41,'임세훈','player',NULL),(2026,42,'김종선','retired',NULL),(2026,43,'최승민','player',NULL),
...
-- ── 게시판 ──────────────────────────────────────────────────────
INSERT INTO posts (title, author, date, views, content) VALUES
...
-- ── 공지사항 ────────────────────────────────────────────────────
INSERT INTO notices (category, is_pinned, title, author, date, views, content) VALUES
...
-- ── 공휴일 ──────────────────────────────────────────────────────
INSERT INTO holidays (year, month, day, type, name, is_fixed) VALUES
